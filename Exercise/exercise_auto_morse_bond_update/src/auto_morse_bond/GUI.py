...
class auto_morse_bond_GUI:
    def __init__(self, topofile, morsefile, parent_directory, newfile, mass_map, min_bond_length, coeffs2skip,
        ...
        styles = [1, 2]
        self.ff_class = ttk.Combobox(self.options_frame, values=styles, width=int(maxwidth/9), font=font_settings)
        ...
        self.atom_style = ttk.Combobox(self.options_frame, values=styles, width=int(maxwidth/9), font=font_settings)
        ...
        styles = [True, False]
        self.zero_effected_xterms = ttk.Combobox(self.options_frame, values=styles, width=int(maxwidth/9), font=font_settings)
        self.zero_effected_xterms.current(styles.index(zero_effected_xterms))
        self.zero_effected_xterms.grid(column=2, row=1)
        self.zero_effected_xterms_label = tk.Label(self.options_frame, text='zero_effected_xterms', font=font_settings)
        self.zero_effected_xterms_label.grid(column=2, row=0)
                
        # include_type_labels drop down menu
        styles = [True, False]
        self.include_type_labels = ttk.Combobox(self.options_frame, values=styles, width=int(maxwidth/9), font=font_settings)
        ...
        styles = [True, False]
        self.include_rcut = ttk.Combobox(self.options_frame, values=styles, width=int(maxwidth/9), font=font_settings)
